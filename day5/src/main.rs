...
#[test]
fn test_eq_8() {
    let bytes = parse("3,9,8,9,10,9,4,9,99,-1,8".to_string());
    let mut computer = Interpreter::new(bytes);
...
#[test]
fn test_lt_8() {
    let bytes = parse("3,9,7,9,10,9,4,9,99,-1,8".to_string());
    let mut computer = Interpreter::new(bytes);
...
#[test]
fn test_eq_ii_8() {
    let bytes = parse("3,3,1108,-1,8,3,4,3,99".to_string());
    let mut computer = Interpreter::new(bytes);
    assert_eq!(vec![1], computer.run(vec![8]));
}
...
#[test]
fn test_jf_pp_z() {
    let bytes = parse("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9".to_string());
    let mut computer = Interpreter::new(bytes);
...
#[test]
fn test_jt_ii_z() {
    let bytes = parse("3,3,1105,-1,9,1101,0,0,12,4,12,99,1".to_string());
    let mut computer = Interpreter::new(bytes);
    assert_eq!(vec![0], computer.run(vec![0]));
}
